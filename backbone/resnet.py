...
class ResNet(nn.Module):
    def __init__(self, block, layers, used_layers):
        ...
        self.conv1 = nn.Conv2d(3, 64, kernel_size=7, stride=1, padding=3,  # 3
                               bias=False)
...
def resnet18(output_layers=None, pretrained=False, **kwargs):
    ...
    model = ResNet(BasicBlock, [2, 2, 2, 2], used_layers=[2, 3, 4], **kwargs)
...
def resnet50(output_layers=None, pretrained=False, **kwargs):
    ...
    model = ResNet(Bottleneck, [3, 4, 6, 3], used_layers=[2, 3, 4], **kwargs)
    # if pretrained:
