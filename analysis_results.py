...
"""pytracking"""
# trackers.extend(trackerlist('ATOM', '', dataset_name, range(0,1), 'ATOM', True))
...
# trackers.extend(trackerlist(name='mamba_fetrack_three', parameter_name='mamba_fetrack_felt_three', dataset_name=dataset_name,
#                             run_ids=None, display_name='mamba_fetrack_three'))

trackers.extend(trackerlist(name='paper3', parameter_name='mamba_fetrack/mamba_fetrack_felt', dataset_name=dataset_name,
                            run_ids=None, display_name='DSTII-MDOT'))


trackers.extend(trackerlist(name='mamba_fetrack_PMSFA', parameter_name='mamba_fetrack_felt', dataset_name=dataset_name,
                            run_ids=None, display_name='ARTrackv2-256'))

trackers.extend(trackerlist(name='mdot_train_best20_49.72_50.84', parameter_name='', dataset_name=dataset_name,
                            run_ids=None, display_name='TransMDOT', result_only=True))
trackers.extend(trackerlist(name='mamba_fetrack_VIT6V2', parameter_name='mamba_fetrack_felt', dataset_name=dataset_name,
                            run_ids=None, display_name='SeqTrack-B-384', result_only=True))
trackers.extend(trackerlist(name='mamba_fetrack(z+text)', parameter_name='mamba_fetrack_felt', dataset_name=dataset_name,
                            run_ids=None, display_name='TATrack ', result_only=True))

trackers.extend(trackerlist(name='ToMP101', parameter_name='', dataset_name=dataset_name,
                            run_ids=None, display_name='DiMP50', result_only=True))

trackers.extend(trackerlist(name='CLNet', parameter_name='', dataset_name=dataset_name,
                            run_ids=None, display_name='CLNet'))


trackers.extend(trackerlist(name='mamba_fetrack_MSPG', parameter_name='mamba_fetrack_felt', dataset_name=dataset_name,
                            run_ids=None, display_name='CRM-DiMP'))

# trackers.extend(trackerlist(name='mamba_fetrack_VIT6', parameter_name='mamba_fetrack_felt', dataset_name=dataset_name,
#                             run_ids=None, display_name='CRM-DiMP'))
...
################### Paper2  START #####################################
# trackers.extend(trackerlist(name='mamba_fetrack_VIT6', parameter_name='mamba_fetrack_felt', dataset_name=dataset_name,
#                             run_ids=None, display_name='TSMMR'))
#
# trackers.extend(trackerlist(name='mdot_train_best20_49.72_50.84', parameter_name='', dataset_name=dataset_name,
#                             run_ids=None, display_name='TransMDOT', result_only=True))
# trackers.extend(trackerlist(name='OSTrack_vitb_384_mae_32x4_ep300_000', parameter_name='', dataset_name=dataset_name,
#                             run_ids=None, display_name='OSTrack384', result_only=True))
# trackers.extend(trackerlist(name='DiMP50', parameter_name='', dataset_name=dataset_name,
#                             run_ids=None, display_name='ToMP50', result_only=True))
#
# trackers.extend(trackerlist(name='ToMP101', parameter_name='', dataset_name=dataset_name,
#                             run_ids=None, display_name='DiMP50', result_only=True))
#
...
# trackers.extend(trackerlist(name='moe', parameter_name='moe_bbox', dataset_name=dataset_name,                  
#                             run_ids=None, display_name='moe_bbox'))

# trackers.extend(trackerlist(name='moe', parameter_name='moe_bbox_alldata', dataset_name=dataset_name,                  
#                             run_ids=None, display_name='moe_bbox_alldata'))

# trackers.extend(trackerlist(name='ostrack_moe', parameter_name='moe_twomdot_28_49.06', dataset_name=dataset_name,
#                             run_ids=None, display_name='ostrack_moe'))

# trackers.extend(trackerlist(name='ostrack_moe', parameter_name='moe_three_50_48.65', dataset_name=dataset_name,                  
#                             run_ids=None, display_name='ostrack_moe'))

# trackers.extend(trackerlist(name='ostrack_moe', parameter_name='moe', dataset_name=dataset_name,
#                             run_ids=None, display_name='ostrack_moe'))
...
# plot_results(trackers, dataset, 'mdot_test', merge_results=True, plot_types=('success', 'norm_prec', 'prec'),
#              skip_missing_seq=False, force_evaluation=True, plot_bin_gap=0.05)
plot_results(trackers, dataset, 'mdot_test', merge_results=True, plot_types=('success', 'norm_prec', 'prec'),
             skip_missing_seq=False, force_evaluation=True, plot_bin_gap=0.05)
